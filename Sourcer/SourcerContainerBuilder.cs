...
public class SourcerContainerBuilder
{
    ...
    public SourcerContainerBuilder Add<TService>(ServiceLifetime serviceLifetime) where TService : notnull => throw new NotImplementedException();
    ...
    public SourcerContainerBuilder Add<TService, TImplementation>(ServiceLifetime serviceLifetime) where TService : notnull where TImplementation : TService => throw new NotImplementedException();
